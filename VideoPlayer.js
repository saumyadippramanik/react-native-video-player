    ...
    */
    ...
    renderTopControls() {
        ...
        return(
            <Animated.View style={[
                ...
                <ImageBackground
                    source={ require( '../Assets/videoPlayerImages/top-vignette.png' ) }
    ...
    renderBack() {
        ...
        return this.renderControl(
            <Image
                source={ require( '../Assets/videoPlayerImages/back.png' ) }
    ...
    renderVolume() {
        ...
        return (
            <View style={ styles.volume.container }>
                ...
                >
                    <Image style={ styles.volume.icon } source={ require( '../Assets/videoPlayerImages/volume.png' ) } />
                </View>
            </View>
        );
    }
    ...
    renderFullscreen() {
        ...
        let source = this.state.isFullscreen === true ? require( '../Assets/videoPlayerImages/shrink.png' ) : require( '../Assets/videoPlayerImages/expand.png' );
        return this.renderControl(
            <Image source={ source } />,
            this.methods.toggleFullscreen,
    ...
    renderBottomControls() {
        ...
        return(
            <Animated.View style={[
                ...
                <ImageBackground
                    source={ require( '../Assets/videoPlayerImages/bottom-vignette.png' ) }
                    style={[ styles.controls.column ]}
                    imageStyle={[ styles.controls.vignette ]}>
                    { seekbarControl }
                    <View style={[
    ...
    renderPlayPause() {
        ...
        let source = this.state.paused === true ? require( '../Assets/videoPlayerImages/play.png' ) : require( '../Assets/videoPlayerImages/pause.png' );
        return this.renderControl(
            <Image source={ source } />,
        ...
        if ( this.state.loading ) {
            return (
                <View style={ styles.loader.container }>
                    <Animated.Image source={ require( '../Assets/videoPlayerImages/loader-icon.png' ) } style={[
                        styles.loader.icon,
                        { transform: [
        ...
        if ( this.state.error ) {
            return (
                <View style={ styles.error.container }>
                    <Image source={ require( '../Assets/videoPlayerImages/error-icon.png' ) } style={ styles.error.icon } />
